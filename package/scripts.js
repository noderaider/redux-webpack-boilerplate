...
exports.default = function (_ref) {
                                                              ...
                                                              return Object.assign.apply(Object, [{}].concat([build('package', function (resource) {
                                                                                                                            ...
                                                                                                                            return 'babel src/config.js -o config.js && babel src/webpack.config.js -o webpack.config.js && babel src/' + resource + '.static.config.js -o ' + resource + '.static.config.js && babel src/' + resource + ' -d ' + resource;
                                                              }, ['copy-config-client', 'copy-config-server', 'build-package', 'build-config']), build('public', function (resource) {
                                                                                                                            return 'ncp src/' + resource + ' ' + resource + ' && webpack --config webpack.static.config.js --progress --profile --colors';
                                                              }, ['build-webpack', 'build-package']), buildWebpack('app', 'webpack.config.js', ['build-public']), buildBabel('bin'), buildBabel('lib'), buildBabel('test'), copy('config-client', 'config-client.json'), copy('config-server', 'config-server.json'), buildBabelFile('config', 'config.js'), copy('app', 'app/vendor', 'public/vendor'), { 'transform': 'transform-package',
