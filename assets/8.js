...
/***/ function(module, exports, __webpack_require__) {
	...
	var Frames = function (_Component) {
	  ...
	  _createClass(Frames, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { type: 'text', onChange: function onChange(_ref) {
	            var target = _ref.target;
	            return _this2.setState({ urlMap: _extends({}, urlMap, _defineProperty({}, 0, value)) });
	          } }),
	        _react2.default.createElement('iframe', { src: urlMap[0], style: frameStyle })
	      );
	    }
	  }]);
